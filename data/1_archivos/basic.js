...
function showold()
{
	...
	document.getElementById('oldlink').style.background="#fff";
...
function shownew()
{
	...
	document.getElementById('newlink').style.background="#fff";
	document.getElementById('bothlink').style.background="";
}
...
function showboth()
{
	...
	document.getElementById('oldlink').style.background="";
	document.getElementById('newlink').style.background="";
	document.getElementById('bothlink').style.background="#fff";
}
